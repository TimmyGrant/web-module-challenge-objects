...
console.log(createMenuItem("Apple Crumble", 8, "Dessert"));
...
*/
let newArr = [...reviews];
function newReview(newArr, name, rating, feedback){
  newArr.push({name, rating, feedback});
  return newArr;
}
console.log(newReview(newArr, "Timmy", 5, "Food was just excellent"));
